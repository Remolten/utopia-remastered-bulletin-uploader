...
if getattr(sys, 'frozen', False):
    # LGPL 2.1 Note: Changed this line and the one below
...
class Theme(object):
    ...
    def _load(self, name):
        ...
        # LGPL 2.1 Note: Changed this line
        #dnames.append(os.path.join(os.path.dirname(__file__),"pgu","data","themes",name))
        dnames.append(os.path.join(os.path.abspath(__file__),"pgu","data","themes",name))
...
#        desty = y
        ...
        surf.set_clip(pygame.Rect(0,0,xx,yy))
